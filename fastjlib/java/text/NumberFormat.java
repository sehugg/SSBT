...
/**
  * This method formats the specified <code>Object</code> and appends it to
  * a <code>StringBuffer</code>.  It does this by first converting the object
  * to a long or double, depending on what type of object it is.
  * 
  * @param number The <code>object</code> to format.
  * @param sb The <code>StringBuffer</code> to append the formatted number to.
  * @param pos The desired <code>FieldPosition</code>.
  *
  * @return The <code>StringBuffer</code> with the appended number.
...
format(Object number, StringBuffer sb, FieldPosition pos)
{
	if (number instanceof Float || number instanceof Double)
		return format( ((Number)number).doubleValue(), sb, pos);
	else if (number instanceof Number)
		return format( ((Number)number).longValue(), sb, pos);
	else
		return format( Double.parseDouble(number.toString()), sb, pos);
}
