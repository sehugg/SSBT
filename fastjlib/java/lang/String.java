...
Character.toLowerCase(value[i]) == Character.toLowerCase(anotherString.value[i]))
  ...
  /**
   * Equivilant to the valueOf() method.
   * @see valueOf
   */
  ...
  /**
   * Compares two String objects for order.
   * Performs a toString() on the string comparing against,
   * then uses compareTo(String) to compare the strings.
   *
   * @see Comparable
   */
