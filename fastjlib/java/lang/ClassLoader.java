...
public abstract class ClassLoader {
	...
	protected final Class defineClass(String name, byte[] data, int offset, int len) throws ClassFormatError {
		Class retval = defineClass(this,name,data,offset,len);
		loadedClasses.put(retval.getName(),retval);
		return retval;
	}
	
	/**
	 ** Native method for defining a class (see above)
	 **/
	protected final static native Class defineClass(ClassLoader loader,
		String name, byte[] data, int offset, int len) throws ClassFormatError;
