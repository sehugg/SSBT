...
public final class Character implements Serializable, Comparable
{
  ...
  static {
	...
	new DataInputStream(new BufferedInputStream(new FileInputStream(blockFile)));
    ...
    try {
      DataInputStream tcIS = new DataInputStream(new BufferedInputStream(new FileInputStream(tcFile)));
