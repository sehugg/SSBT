 ...
 *
 * @version $Id: InstructionList.java,v 1.1.1.1 2000/01/24 14:39:32 hugg Exp $
 * @author  <A HREF="http://www.inf.fu-berlin.de/~dahm">M. Dahm</A>
 * @see     Instruction
 * @see     InstructionHandle
 * @see     BranchHandle
 */
public class InstructionList implements Constants, Serializable {
  ...
  public void setPositions(boolean check) {
	...
	if(i instanceof BranchInstruction) { // target instruction within list?
	  ...
	  if(!(ih instanceof BranchHandle))
	    throw new ClassGenException("Branch instruction " + OPCODE_NAMES[i.tag] + ":" +
